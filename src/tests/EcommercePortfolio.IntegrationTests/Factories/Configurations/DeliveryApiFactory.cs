...
public class DeliveryApiFactory(
    string rabbitMqConnectionString,
    string redisDbConnectionString,
    string postgresDbConnectionString,
    string orderApiUrl) : WebApplicationFactory<Deliveries.API.Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((context, configBuilder) =>
        {
            ...
            [
                new KeyValuePair<string, string>("ConnectionStrings:DeliveryPostgresDbConnection", postgresDbConnectionString),
                ...
                new KeyValuePair<string, string>("ApiSettings:OrderApiUrl", orderApiUrl),
            ]);
        });
    }
}